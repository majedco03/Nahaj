<script lang="ts">
	...
	export let nahajCourses: { id: string; code: string; name: string }[] = [];
	export let selectedNahajCourseId = '';
	export let selectedNahajCollection: 'slides' | 'past_exam' = 'slides';
